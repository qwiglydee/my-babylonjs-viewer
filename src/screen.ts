...
export class MyLoadingScreen extends LitElement implements ILoadingScreen {
    ...
    static override styles = css`
        :host {
            ...
            align-items: center;
            background-color: var(--my-background-color, #202020);
            opacity: 1;
        }
